...
- **Document component `Props`** — add JSDoc comments to each field in the `Props` interface so component APIs are self-explanatory (see [`code-quality.instructions.md`](code-quality.instructions.md) for examples)
